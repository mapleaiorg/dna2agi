...
\begin{tikzpicture}[scale=0.95]
  ...
  % Dominated point
  \fill[dogmagray] (2.5,1.5) circle (3pt) node[right, font=\small] {$D$ (dominated)};
...
\begin{tikzpicture}[
  ...
  \node[state] (ext) at (30:3.5) {EXT};
  \node[state] (sch) at (-30:3.5) {SCH};
  \node[state] (eff) at (-90:3.5) {EFF};
  \node[state] (exp) at (-150:3.5) {EXP};
  \node[state] (coh) at (150:3.5) {COH};

  % Crisis state (below)
  \node[crisis] (crisis) at (0,-5.5) {CRISIS};
  ...
  \draw[crisis_trans] (bal) -- (crisis) node[midway, right, text=dogmared, font=\scriptsize] {all $p > \theta_c$};
  ...
  \draw[trans, dogmateal, bend right=30] (crisis) to node[midway, left, text=dogmateal, font=\scriptsize] {$\bar{p} < \theta_c{-}0.1$} (bal);
...
\[
\mathbf{R}_1 = 0.8 \times (0.5, 0.5, 0.5, 0.5, 0.5, 0.5) + 0.2 \times (0.9, 0.3, 0.2, 0.4, 0.3, 0.3) = (0.58, 0.46, 0.44, 0.48, 0.46, 0.46).
\]
...
\[
\mathbf{R}_2 = 0.8 \times (0.58, 0.46, 0.44, 0.48, 0.46, 0.46) + 0.2 \times (0.95, 0.25, 0.2, 0.35, 0.2, 0.25) = (0.654, 0.418, 0.392, 0.454, 0.418, 0.418).
\]
...
\textbf{Pressure update:}
\[
\mathbf{R}_3 = 0.8 \times (0.654, 0.418, 0.392, 0.454, 0.418, 0.418) + 0.2 \times (0.4, 0.3, 0.85, 0.3, 0.25, 0.3) = (0.603, 0.394, 0.484, 0.423, 0.384, 0.394).
\]
...
\textbf{Pressure update:}
\[
\mathbf{R}_4 = 0.8 \times (0.603, 0.394, 0.484, 0.423, 0.384, 0.394) + 0.2 \times (0.3, 0.35, 0.9, 0.3, 0.3, 0.35) = (0.542, 0.385, 0.567, 0.398, 0.367, 0.385).
\]
...
\textbf{Pressure update:}
\[
\mathbf{R}_5 = 0.8 \times (0.542, 0.385, 0.567, 0.398, 0.367, 0.385) + 0.2 \times (0.2, 0.3, 0.95, 0.25, 0.2, 0.3) = (0.474, 0.368, 0.644, 0.368, 0.334, 0.368).
\]
...
\begin{tikzpicture}[scale=0.85]
  ...
  \node[draw=dogmablue, fill=dogmalight, thick, rounded corners,
    ...
    (fwd) at (0,4) {Forward Strand\\$F_t$};

  \node[draw=dogmablue, fill=dogmalight, thick, rounded corners,
    minimum width=\boxw, minimum height=\boxh, align=center, font=\small]
    (rev) at (4,4) {Reverse Strand\\$R_t$};
  ...
  \node[draw=dogmagray, fill=dogmagray!10, thick, rounded corners,
    minimum width=\boxw, minimum height=\boxh, align=center, font=\small]
    (archive) at (6,0) {Archive/Lineage\\$C_t$};
