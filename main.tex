...
\noindent First Edition, v1.1, March 2026.\\[6pt]
...
\input{chapters/part1-ch01-dna-information}
\input{chapters/part1-ch02-dna-computing}
\input{chapters/part1-ch03-gene-regulation}
\input{chapters/part2-ch04-ml-foundations}
\input{chapters/part2-ch05-transformers-llms}
\input{chapters/part2-ch06-bio-foundation-models}
\input{chapters/part3-ch07-dogma-architecture}
\input{chapters/part3-ch08-helixhash}
\input{chapters/part3-ch09-tera}
\input{chapters/part3-ch10-tetradata}
\input{chapters/part3-ch11-codonforge}
\input{chapters/part4-ch12-evolutionary-training}
\input{chapters/part4-ch13-genomic-foundation-models}
\input{chapters/part4-ch14-dogma-supreme}
\input{chapters/part5-ch15-scaling-post-transformer}
\input{chapters/part5-ch16-agi-paths}
\input{chapters/part5-ch17-ethics-safety}
\input{chapters/part6-ch18-labs}
\input{chapters/part6-ch19-epilogue}

% ─── Appendices ──────────────────────────────────────────────────────────────
\appendix
\input{appendices/appendix-a-math}
